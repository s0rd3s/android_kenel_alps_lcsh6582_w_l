...
#define FOCAL_TAG "FOCAL-TP-TAG"
#define FOCAL_DMESG(fmt,arg...)          xlog_printk(ANDROID_LOG_INFO,FOCAL_TAG,"<<-CTP-INFO->> "fmt"\n",##arg)
#define FOCAL_ERROR(fmt,arg...)          xlog_printk(ANDROID_LOG_INFO,FOCAL_TAG,"<<-CTP-ERROR->> "fmt"\n",##arg)
#define FOCAL_DEBUG(fmt,arg...)          do{\
                                            if(CTP_DEBUG_ON)\
                                            xlog_printk(ANDROID_LOG_INFO,FOCAL_TAG,"<<-CTP-DEBUG->> [%d]"fmt"\n",__LINE__, ##arg);\
                                        }while(0)
