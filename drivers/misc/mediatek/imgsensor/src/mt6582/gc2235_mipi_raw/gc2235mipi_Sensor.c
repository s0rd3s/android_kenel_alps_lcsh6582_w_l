...
static void GC2235MIPI_Sensor_Init(void)
{
	...
	/////////////////////////////////////////////////////
#ifdef GC2235_MIPI_2_Lane
	GC2235MIPI_write_cmos_sensor(0x03, 0x03);  // 54b
	GC2235MIPI_write_cmos_sensor(0x04, 0x2d);
	...
	GC2235MIPI_write_cmos_sensor(0x04, 0x78);
	GC2235MIPI_write_cmos_sensor(0x05, 0x00);
	GC2235MIPI_write_cmos_sensor(0x06, 0xe3);
	GC2235MIPI_write_cmos_sensor(0x07, 0x00);
...
UINT32 GC2235MIPIGetSensorID(UINT32 *sensorID) 
{
	...
	*sensorID=((GC2235MIPI_read_cmos_sensor(0xf0) << 8) | GC2235MIPI_read_cmos_sensor(0xf1));	
	...
	printk("[++++GC2235_adc_huaquan++++] data0: %d , data1 = %d\n", data[0],data[1]);
	if(*sensorID == GC2235MIPI_SENSOR_ID && data[0] ==0){//huaquan:data[0] ==0,shengtai:data[0] ==1
   		return ERROR_NONE;
	}else{
		*sensorID = 0xFFFFFFFF;	
		return ERROR_SENSOR_CONNECT_FAIL;
...
{	
	...
	if(bEnable)		
	{		
		GC2235MIPI_write_cmos_sensor(0x8c,0x12);
