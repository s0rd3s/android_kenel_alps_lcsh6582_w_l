	...
	else
	{
   		...
   		if(mt_usb_is_device())
			...
			if (charging_get_error_state()) {
				battery_xlog_printk(BAT_LOG_CRTI,"[charging_enable] bq24196_set_en_hiz(0x1)\n");
...
//extern G_CHARGER_TYPE hw_charger_type_detection(void);
...
static kal_uint32 charging_get_charger_type(void *data)
{
	...
	g_charger_type = hw_get_charger_type();
