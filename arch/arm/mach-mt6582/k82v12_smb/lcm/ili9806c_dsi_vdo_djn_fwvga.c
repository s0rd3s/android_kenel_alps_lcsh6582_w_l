...
static LCM_setting_table_V3  lcm_deep_sleep_mode_out_setting[] = {
	// Display off sequence
	{0x05, 0x11, 0, {}},
	{REGFLAG_ESCAPE_ID,REGFLAG_DELAY_MS_V3, 10, {}},
...
{
	//lcm_init();
	dsi_set_cmdq_V3(lcm_deep_sleep_mode_out_setting, sizeof(lcm_deep_sleep_mode_out_setting)/sizeof(lcm_deep_sleep_mode_out_setting[0]), 1);
}
